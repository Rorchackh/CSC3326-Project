<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<h2>Create a new account</h2>
     ...
     <asp:Label ID="Label1" runat="server" Text="UserID: "></asp:Label></td>
         ...
         <tr>
             <td class="style2">
                 <asp:Label ID="Label5" runat="server" Text="FirstName: "></asp:Label></td>
             <td>
                 <asp:TextBox ID="TextBox5" runat="server" Width="158px"></asp:TextBox>
                  ...
                  <tr>
             <td class="style2">
                 <asp:Label ID="Label6" runat="server" Text="Lastname: "></asp:Label></td>
             <td>
