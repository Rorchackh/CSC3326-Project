<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="EditAddresse.aspx.cs" Inherits="_Default" Title="Untitled Page" %>
...
<center><b><h1>Change your Addresse</h1></b></center>
    
     <table style="width:100%;">
         <tr>
             <td class="style2">
    
     <asp:Label ID="Label1" runat="server" Text="Adresse Num: "></asp:Label></td>
             <td>
         ...
         <tr>
             <td class="style2">
                 <asp:Label ID="Label2" runat="server" Text="Street: "></asp:Label></td>
             <td>
         ...
         <tr>
             <td class="style2">
                 <asp:Label ID="Label3" runat="server" Text="ZipCode: "></asp:Label></td>
             <td>
         ...
         <tr>
             ...
             <td>
                 <asp:DropDownList id="Answer" runat="server" Width="158px">
    ...
    <asp:ListItem Value="ZW">Zimbabwe</asp:ListItem>
         ...
         <tr>
         <td>
             <asp:Button ID="Button2" runat="server" Text="UpDate Adresse" 
